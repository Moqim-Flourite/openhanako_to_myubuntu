...
export class BridgeManager {
   ...
   */
  async sendMediaItem(platform, chatId, mediaItem, agentId, opts = {}) {
    const entry = this._findPlatformEntry(platform, agentId);
    ...
    await this._sendMediaItem(entry.adapter, chatId, mediaItem, { platform, agentId: entry.agentId || agentId || null, isGroup: opts.isGroup });
  }
